...
class Styles {
  ...
  static TextStyle headLineStyle4 = TextStyle(fontSize: 14, color: textColor, fontWeight: FontWeight.bold);
  static TextStyle headLineStyle5 = TextStyle(fontSize: 17, color: Colors.grey.shade500, fontWeight: FontWeight.w500);
  static TextStyle headLineStyle6 = const TextStyle(fontSize: 17, color: Colors.black87, fontWeight: FontWeight.bold);
  static TextStyle headLineStyle7 = TextStyle(fontSize: 26, color: Colors.deepPurple, fontWeight: FontWeight.bold);
